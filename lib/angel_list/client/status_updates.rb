module AngelList
  class Client
    ...
    module StatusUpdates
      ...
      #   AngelList.get_status_updates
      #
      # @example Get status updates for the startup with ID 1234.
      #   AngelList.get_status_updates(:startup_id => 1234)
      ...
      #   AngelList.post_status_updates(:message => "Startup advice: Don't fuck up.")
      ...
      #   AngelList.delete_status_updates(1234)
