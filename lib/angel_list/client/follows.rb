module AngelList
  class Client
    ...
    module Follows
      ...
      #   AngelList.new_follow(:type => :startup, :id => 12345)
      ...
      #   AngelList.delete_follow(:type => :startup, :id => 12345)
      ...
      #   AngelList.get_user_followers(12345)
      ...
      #   AngelList.get_user_follower_ids(12345)
      ...
      #   AngelList.get_user_following(1234, :type => :startup)
      ...
      #   AngelList.get_user_following_ids(1234, :type => :startup)
      ...
      #   AngelList.get_startup_followers(1234)
      ...
      #   AngelList.get_startup_follower_ids(1234)
