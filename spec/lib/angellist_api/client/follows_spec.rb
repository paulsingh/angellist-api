...
describe AngellistApi::Client::Follows do
  ...
  describe "#new_follow" do
    it "posts to 1/follows" do
      ...
      client.should_receive(:post).with("1/follows", options, :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#delete_follow" do
    it "deletes 1/follows" do
      options = { :some => "options" }
      client.should_receive(:delete).with("1/follows", options, :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_user_followers" do
    it "gets 1/users/<id>/followers" do
      id = "123"
      client.should_receive(:get).with("1/users/#{id}/followers", :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_user_follower_ids" do
    it "gets 1/users/<id>/followers/ids" do
      id = "123"
      client.should_receive(:get).with("1/users/#{id}/followers/ids", :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_user_following" do
    it "gets 1/users/<id>/following" do
      id = "123"
      options = { :some => "options" }
      client.should_receive(:get).with("1/users/#{id}/following", options, :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_user_following_ids" do
    it "gets 1/users/<id>/following/ids" do
      id = "123"
      options = { :some => "options" }
      client.should_receive(:get).with("1/users/#{id}/following/ids", options, :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_startup_followers" do
    it "gets 1/startups/<id>/followers" do
      id = "123"
      client.should_receive(:get).with("1/startups/#{id}/followers", :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_startup_follower_ids" do
    it "gets 1/startups/<id>/followers/ids" do
      id = "123"
      client.should_receive(:get).with("1/startups/#{id}/followers/ids", :format => :json, :phoenix => true).and_return("success")
