...
describe AngellistApi::Client::Tags do
  ...
  describe "#get_tag" do
    it "gets 1/tags/<id>" do
      id = "123"
      client.should_receive(:get).with("1/tags/#{id}", :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_tag_children" do
    it "gets 1/tags/<id>/children" do
      id = "123"
      client.should_receive(:get).with("1/tags/#{id}/children", :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_tag_parents" do
    it "gets 1/tags/<id>/parents" do
      id = "123"
      client.should_receive(:get).with("1/tags/#{id}/parents", :format => :json, :phoenix => true).and_return("success")
  ...
  describe "#get_tag_startups" do
    it "gets 1/tags/<id>/startups" do
      ...
      client.should_receive(:get).with("1/tags/#{id}/startups", options, :format => :json, :phoenix => true).and_return("success")
